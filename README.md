...
Найдено: 123-456-7 в позиции 30
Найдено: 123 456 7 в позиции 41
```
...
### Тестовый пример:
```string text = "Книги: ISBN-13: 9780306406157, 978-0-306-40615-7, 1234567890123";```
### Вывод
```
Найдено: ISBN-13: 9780306406157 в позиции 7
Найдено: 978-0-306-40615-7 в позиции 31
Найдено: 1234567890123 в позиции 51
```
